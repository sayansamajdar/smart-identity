...
public class Utils {
	...
	for (final ClassPath.ClassInfo info : getClassesFromPackage("com.techengage.verification.bootstrap")) {
	...
	for (final ClassPath.ClassInfo info : getClassesFromPackage("com.techengage.verification.routes")) {
	...
	for (final ClassPath.ClassInfo info : getClassesFromPackage("com.techengage.verification.verticle")) {
