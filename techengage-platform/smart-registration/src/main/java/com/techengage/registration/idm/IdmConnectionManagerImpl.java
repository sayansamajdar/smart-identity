...
public class IdmConnectionManagerImpl implements IdmConnectionManager {
    ...
    private static IdmConnectionManagerImpl instance = null;

    private IdmConnectionManagerImpl() {
    }

    public static IdmConnectionManagerImpl getInstance() {
	if (instance == null) {
	    instance = new IdmConnectionManagerImpl();
	}
	return instance;
    }
	...
	try {
	    ...
	    System.out.println("storedProfileData : " + storedProfileData);
	...
	try {
	    System.out.println("finalized userProfile : " + userProfile + ", storedProfileData : " + storedProfileData);
